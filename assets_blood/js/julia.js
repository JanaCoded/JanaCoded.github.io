...
function draw() {
 ...
 //---------------------------------------------------------------------------------------------------------------------------
    ...
    for (var i = 0; i < 30; i++) {
        ellipse(xKoord + (xDelta * i), yKoord + sin(frameCount/30-((2*PI/10)*i)) * 100, durchmesser, durchmesser);
    }
 ...
 //---------------------------------------------------------------------------------------------------------------------------
    ...
    for (var i = 0; i < 80; i++) {
        rect(xKoord + (xDelta * i), yKoord + sin(frameCount/80-((4*PI/200)*i)) * 600, durchmesser, durchmesser);
    }
