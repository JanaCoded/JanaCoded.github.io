...
function draw() {
 ...
 //---------------------------------------------------------------------------------------------------------------------------
    ...
    for (var i = 0; i < 50; i++) {
        ellipse(xKoord + (xDelta * i), yKoord + sin(frameCount/50-((2*PI/10)*i)) * 200, durchmesser, durchmesser);
    }
 ...
 //---------------------------------------------------------------------------------------------------------------------------
    ...
    for (var i = 0; i < 80; i++) {
        rect(xKoord + (xDelta * i), yKoord + sin(frameCount/50-((6*PI/200)*i)) *600, durchmesser, durchmesser);
    }
